...
/**
 * DelTemplatePadFragment
 * used for deleting temps stored in the preferences
 * */
public class DelTemplatePadFragment extends Fragment implements AnimTempItemDelAdapter.OnAniTempDelListener {
    private static final String TAG = "DelTemplatePadFragment Fragment";
